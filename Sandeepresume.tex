...
\name{Sandeep Singh}{Negi}
\position{Software Engineer}
\mobile{(+91) 7973882172}
\email{negi.sandeep01906@gmail.com}
\github{sandeepnegi1996}
\linkedin{sandeepnegi1996}
% \gitlab{gitlab-id}
