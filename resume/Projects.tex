...
%---------------------------------------------------------
 ...
 \cventry
    {Pet Project} % Affiliation/role
    {{Todo-App}} % Organization/group
    {Coimbatore, Tamil Nadu} % Location
...
\cventry
    {Pet Project} % Affiliation/role
    {{Art Gallery}} % Organization/group
    {Coimbatore, Tamil Nadu} % Location
...
\cventry
    {Pet Project} % Affiliation/role
    {{Temperature-Converter}} % Organization/group
    {Coimbatore, Tamil Nadu} % Location
    {Mar. 2019 - Mar. 2019} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%----------------------------------------------------------------
    ...
    \cventry
    {Pet Project} % Affiliation/role
    {{Digital-Clock}} % Organization/group
    {Coimbatore, Tamil Nadu} % Location
    {Mar. 2019 - Mar. 2019} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
